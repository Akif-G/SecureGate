    ...
    render() {
        return (
            <div className="Content" style={{ backgroundColor: this.props.BG }}>
                ...
                <p className="Information" style={{top:"43rem",fontSize:"1rem"}}>We are trying to develop bug-free and refreshing interface for the ease of usage of a contract Dapp. If you'd like to help us, see our code or the contract details; you can reach us by clicking to the github icon.</p>
